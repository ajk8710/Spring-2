...
public class ProductClient {
    ...
    public JsonNode saveProductToOtherProject(JsonNode json) {  // get json from controller
        ...
        ResponseEntity<Object> responseEntity =          // and receive response back from another project
                restTemplate.postForEntity("http://localhost:8282/saveProduct", request, Object.class);
